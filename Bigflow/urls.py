...
from Bigflow.Proofing import urls as ProofingUrl
...
urlpatterns = [
                  ...
                  # Courier
                  path('Courier/', master.courier_index, name='Courier'),
                  path('get_courier_summary/', master.courier_summary_get, name='get_courier_summary'),
                  path('courier_set/', master.courier_set, name='courier_set'),
