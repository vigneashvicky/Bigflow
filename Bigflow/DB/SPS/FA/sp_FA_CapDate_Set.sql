CREATE DEFINER=`developer`@`%` PROCEDURE `sp_FA_CapDate_Set`(IN `ls_Action` varchar(32),IN `ls_Type` varchar(32),
                                ...
                                set countRow = (select ROW_COUNT());
                                  ...
                                  End if;
									...
									set Message = 'SUCCESS';
										...
										#	  where   assetdetails_trangid=@CapDate_Maxgid into @CapDate_Reftable_Gid;
