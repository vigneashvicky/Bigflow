CREATE DEFINER=`developer`@`%` PROCEDURE `sp_FAWriteoff_Set`(IN `ls_Action` varchar(32),IN `ls_Type` varchar(32),IN `ls_Sub_Type` varchar(32),
                ...
                set @ls_Status = 'REQUESTED';
                              ...
                              if countRow > 0 then
                                  ...
                                  set countRow = (select ROW_COUNT());
                                    ...
                                    call sp_Trans_Set('Insert','FA_WRITEOFF',@writeoff_Maxgid,'NEW','G','MAKER',@WriteOff_Reason,@Entity_Gid,ls_Createby,@message);
